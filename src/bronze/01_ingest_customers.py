...
Reads the oldest pending customers*.csv from to_process (pattern-matched),
writes bronze_customers, then archives the file to processed with its
original timestamped filename preserved.
"""
...
from bronze_config import (  # noqa: E402
    CUSTOMERS_SOURCE_FILENAME_PATTERN,
