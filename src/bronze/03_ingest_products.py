...
Reads products.csv from the DBFS to_process folder as-is with no
transformations, writes bronze_products, then archives the file to the
DBFS processed folder.
"""
