...
Reads orders.csv from the DBFS to_process folder as-is (including NULL FKs,
orphan references, and duplicate order IDs), writes bronze_orders, then
archives the file to the DBFS processed folder.
"""
